  ...
  render() {
    return (
      <div className="content">
        ...
        {this.state.name &&  <Button className="btn-fill" color="primary" type="submit" onClick={this.getCreateUserApi(this.state.name.split(" ").join(''),'12345678')} >create sleep Graph</Button>}
